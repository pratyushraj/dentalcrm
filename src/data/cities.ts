export interface CityData {
  slug: string;       // URL: /cities/mumbai
  name: string;       // Display: Mumbai
  state: string;      // Maharashtra
  tier: 1 | 2 | 3;   // Used to adjust copy (Tier-1 metros get slightly different phrasing)
}
...
export const CITIES: CityData[] = [
  ...
  { slug: "pimpri-chinchwad", name: "Pimpri-Chinchwad", state: "Maharashtra", tier: 2 },
  ...
  { slug: "srinagar", name: "Srinagar", state: "Jammu & Kashmir", tier: 2 },
  { slug: "aurangabad", name: "Aurangabad", state: "Maharashtra", tier: 2 },
  { slug: "dhanbad", name: "Dhanbad", state: "Jharkhand", tier: 2 },
  { slug: "amritsar", name: "Amritsar", state: "Punjab", tier: 2 },
  { slug: "navi-mumbai", name: "Navi Mumbai", state: "Maharashtra", tier: 2 },
  { slug: "allahabad", name: "Prayagraj", state: "Uttar Pradesh", tier: 2 },
  { slug: "ranchi", name: "Ranchi", state: "Jharkhand", tier: 2 },
  { slug: "haora", name: "Howrah", state: "West Bengal", tier: 2 },
  { slug: "coimbatore", name: "Coimbatore", state: "Tamil Nadu", tier: 2 },
  { slug: "jabalpur", name: "Jabalpur", state: "Madhya Pradesh", tier: 2 },
  { slug: "gwalior", name: "Gwalior", state: "Madhya Pradesh", tier: 2 },
  ...
  { slug: "raipur", name: "Raipur", state: "Chhattisgarh", tier: 2 },
  ...
  { slug: "solapur", name: "Solapur", state: "Maharashtra", tier: 2 },
  { slug: "hubli-dharwad", name: "Hubli-Dharwad", state: "Karnataka", tier: 2 },
  { slug: "bareilly", name: "Bareilly", state: "Uttar Pradesh", tier: 2 },
  { slug: "moradabad", name: "Moradabad", state: "Uttar Pradesh", tier: 2 },
  { slug: "mysore", name: "Mysuru", state: "Karnataka", tier: 2 },
  { slug: "gurgaon", name: "Gurugram", state: "Haryana", tier: 2 },
  { slug: "noida", name: "Noida", state: "Uttar Pradesh", tier: 2 },

  // Tier 3 – Emerging Cities
  { slug: "tiruppur", name: "Tiruppur", state: "Tamil Nadu", tier: 3 },
  { slug: "salem", name: "Salem", state: "Tamil Nadu", tier: 3 },
  { slug: "warangal", name: "Warangal", state: "Telangana", tier: 3 },
  ...
  { slug: "amravati", name: "Amravati", state: "Maharashtra", tier: 3 },
  { slug: "noida-extension", name: "Noida Extension", state: "Uttar Pradesh", tier: 3 },
  { slug: "dehradun", name: "Dehradun", state: "Uttarakhand", tier: 3 },
  { slug: "shimla", name: "Shimla", state: "Himachal Pradesh", tier: 3 },
  { slug: "mangalore", name: "Mangaluru", state: "Karnataka", tier: 3 },
  { slug: "kochi", name: "Kochi", state: "Kerala", tier: 3 },
  ...
  { slug: "belgaum", name: "Belagavi", state: "Karnataka", tier: 3 },
  ...
  { slug: "gulbarga", name: "Kalaburagi", state: "Karnataka", tier: 3 },
  { slug: "jamshedpur", name: "Jamshedpur", state: "Jharkhand", tier: 3 },
  { slug: "bhilai", name: "Bhilai", state: "Chhattisgarh", tier: 3 },
  ...
  { slug: "loni", name: "Loni", state: "Uttar Pradesh", tier: 3 },
  { slug: "nanded", name: "Nanded", state: "Maharashtra", tier: 3 },
  { slug: "kolhapur", name: "Kolhapur", state: "Maharashtra", tier: 3 },
  { slug: "vasai-virar", name: "Vasai-Virar", state: "Maharashtra", tier: 3 },
  { slug: "jalgaon", name: "Jalgaon", state: "Maharashtra", tier: 3 },
  { slug: "akola", name: "Akola", state: "Maharashtra", tier: 3 },
];

// Helper to get a city by slug
