...
export default function CrmHomepage() {
  ...
  const ALL_LENDERS = [
    ...
    { id: 'hero', name: 'Hero Fincorp', rate: '18%–30% p.a.', minCibil: 725, salaryOnly: false, minIncome: 15000, url: 'https://partners.marcadeo.com/click?oid=344&uid=1895&lid=335', badge: 'Zero Cost EMI', color: 'bg-blue-50 border-blue-200 text-blue-700' },
